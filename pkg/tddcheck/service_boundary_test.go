...
func TestModuleServiceRuleViolations(t *testing.T) {
	...
	writeFile(t, root, "good/service.go", `package good
...
func (s *Service) Run() {}
`)
	writeFile(t, root, "good/service.auth.go", `package good

func (s *Service) Login() {}
func (s Service) Logout() {}
`)
	writeFile(t, root, "bad/service.extra.go", `package bad
...
func (s *Service) Run() {}
`)
	writeFile(t, root, "bad/handler_test.go", `package bad
